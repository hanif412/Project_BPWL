...
<a class="btn btn-sm btn-info mb-3" href="<?php echo base_url('admin/dataNilai/register')?>"><i class="fas fa-plus"></i> Tambah Data Nilai Mahasiswa</a>
...
<thead class="thead-light">
    ...
    <tr>
        ...
        <td class="text-center">
            <a class="btn btn-sm btn-success" href="<?php echo base_url('admin/dataNilai/edit/'.$h->nim)?>"><i class="fas fa-tools"></i></a>
        </td>
        <td class="text-center">
            <a class="btn btn-sm btn-danger" href="<?php echo base_url('admin/dataNilai/hapus/'.$h->nim)?>"><i class="far fa-trash-alt"></i></a>
        </td>
    <tr>
    <?php endforeach; ?>    
</table>
