...
<a class="btn btn-sm btn-info mb-3" href="<?php echo base_url('admin/dataMahasiswa/register')?>"><i class="fas fa-plus"></i> Tambah Data Mahasiswa</a>
...
<thead class="thead-light">
    ...
    <tr>
        ...
        <td class="text-center">
            <a class="btn btn-sm btn-success" href="<?php echo base_url('admin/dataMahasiswa/edit/'.$h->nim)?>"><i class="fas fa-tools"></i></a>
        </td>
        <td class="text-center">
